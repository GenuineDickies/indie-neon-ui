...
- **Lightweight** - ~150KB minified (CDN single file)
...
```
indie-neon-ui/
├── css/          # Source CSS files (23 component files)
├── js/           # Source JavaScript modules (6 modules)
├── dist/         # Built files (generated by npm run build)
├── index.html    # Complete component documentation
...
```
Then open:
- **Component Library**: http://localhost:8080/index.html (complete documentation)
- **Interactive Demo**: http://localhost:8080/demo.html (with color slider)

### Build Process
```bash
node build.js  # Builds minified CSS and JS files
```

### Development Guidelines

**⚠️ Important: Cache Busting Policy**

When modifying CSS or JavaScript files, you **must** update version numbers in HTML files to prevent browser caching issues. See [DEVELOPMENT.md](DEVELOPMENT.md) for complete guidelines.

**Quick Reference:**
- Edit CSS/JS → Run `node build.js` → Update version numbers in HTML files → Test → Commit

For detailed development workflows, see:
- **[DEVELOPMENT.md](DEVELOPMENT.md)** - Complete development guide for contributors
- **[.cursorrules](.cursorrules)** - AI agent development rules
...
- ✅ Run `node build.js` to generate minified distribution files
- ✅ Update version numbers in HTML files (cache busting)
- ✅ Test all components in target browsers
- ✅ Verify accessibility with screen readers
- ✅ Check mobile responsiveness
- ✅ Validate HTML/CSS/JS (no console errors)
- ✅ Optimize images and assets
- ✅ Configure CDN or hosting service
...
**CDN Integration**
```html
<!-- Use unpkg for automatic updates -->
<link rel="stylesheet" href="https://unpkg.com/indie-neon-ui@1.0.0/dist/indie-neon-ui.min.css">
<script src="https://unpkg.com/indie-neon-ui@1.0.0/dist/indie-neon-ui.min.js"></script>
```
...
- Use minified versions (`*.min.css`, `*.min.js`) in production
